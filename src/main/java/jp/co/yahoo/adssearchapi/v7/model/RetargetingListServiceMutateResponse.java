...
import jp.co.yahoo.adssearchapi.v7.model.RetargetingListServiceReturnValue;
...
public class RetargetingListServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private RetargetingListServiceReturnValue rval = null;
  ...
  */
  ...
  public RetargetingListServiceReturnValue getRval() {
    return rval;
  }

  public void setRval(RetargetingListServiceReturnValue rval) {
    this.rval = rval;
  }
