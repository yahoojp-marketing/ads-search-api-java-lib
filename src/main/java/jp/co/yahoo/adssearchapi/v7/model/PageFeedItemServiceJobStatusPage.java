...
import jp.co.yahoo.adssearchapi.v7.model.PageFeedItemServiceJobValue;
...
public class PageFeedItemServiceJobStatusPage   {
  ...
  @JsonProperty("values")
  @Valid
  private List<PageFeedItemServiceJobValue> values = null;
  ...
  */
  ...
  public List<PageFeedItemServiceJobValue> getValues() {
    return values;
  }

  public void setValues(List<PageFeedItemServiceJobValue> values) {
    this.values = values;
  }
