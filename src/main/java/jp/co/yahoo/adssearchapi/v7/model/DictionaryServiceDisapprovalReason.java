...
import jp.co.yahoo.adssearchapi.v7.model.DictionaryServiceLang;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">DictionaryServiceDisapprovalReason オブジェクトは、 EditorialReason一覧を格納するコンテナです。</div> <div lang=\"en\">DictionaryServiceDisapprovalReason object is a container which stored the Description of disapproval reason and the Recommended solution.</div> ")
...
public class DictionaryServiceDisapprovalReason   {
  ...
  */
  @ApiModelProperty(value = "<div lang=\"ja\">審査コードです。</div> <div lang=\"en\">Editorial code</div> ")
  ...
  */
  @ApiModelProperty(value = "<div lang=\"ja\">推奨する対応方法です。</div> <div lang=\"en\">Recommended solution</div> ")
