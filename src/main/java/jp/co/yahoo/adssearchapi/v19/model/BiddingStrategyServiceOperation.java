 ...
 */
@JsonPropertyOrder({
  BiddingStrategyServiceOperation.JSON_PROPERTY_ACCOUNT_ID,
  BiddingStrategyServiceOperation.JSON_PROPERTY_OPERAND
})
...
public class BiddingStrategyServiceOperation {
  ...
  private List<BiddingStrategy> operand;

  public BiddingStrategyServiceOperation() {
  }
