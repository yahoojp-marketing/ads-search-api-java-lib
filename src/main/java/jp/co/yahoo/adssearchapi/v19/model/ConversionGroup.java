...
import jp.co.yahoo.adssearchapi.v19.model.ConversionGroupServiceConversionTrackers;
...
@JsonPropertyOrder({
  ...
  ConversionGroup.JSON_PROPERTY_CONVERSION_TRACKERS
})
...
public class ConversionGroup {
  ...
  public static final String JSON_PROPERTY_CONVERSION_TRACKERS = "conversionTrackers";
  private List<ConversionGroupServiceConversionTrackers> conversionTrackers;
  ...
  **/
  ...
  public ConversionGroup conversionTrackers(List<ConversionGroupServiceConversionTrackers> conversionTrackers) {
    
    this.conversionTrackers = conversionTrackers;
    return this;
  }

  public ConversionGroup addConversionTrackersItem(ConversionGroupServiceConversionTrackers conversionTrackersItem) {
    if (this.conversionTrackers == null) {
      this.conversionTrackers = new ArrayList<>();
    }
    this.conversionTrackers.add(conversionTrackersItem);
    return this;
  }

   /**
   * Get conversionTrackers
   * @return conversionTrackers
  **/
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CONVERSION_TRACKERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<ConversionGroupServiceConversionTrackers> getConversionTrackers() {
    return conversionTrackers;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CONVERSION_TRACKERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConversionTrackers(List<ConversionGroupServiceConversionTrackers> conversionTrackers) {
    this.conversionTrackers = conversionTrackers;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, conversionGroup.accountId) &&
        ...
        Objects.equals(this.conversionTrackers, conversionGroup.conversionTrackers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, conversionGroupId, conversionGroupName, conversionTrackers);
  }
  ...
  public String toString() {
    ...
    sb.append("    conversionTrackers: ").append(toIndentedString(conversionTrackers)).append("\n");
    sb.append("}");
    return sb.toString();
  }
