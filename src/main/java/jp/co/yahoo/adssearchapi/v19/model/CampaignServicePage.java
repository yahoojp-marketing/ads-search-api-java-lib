 ...
 */
@JsonPropertyOrder({
  CampaignServicePage.JSON_PROPERTY_TOTAL_NUM_ENTRIES,
  CampaignServicePage.JSON_PROPERTY_VALUES
})
...
public class CampaignServicePage {
  ...
  private List<CampaignServiceValue> values;

  public CampaignServicePage() {
  }
