...
import jp.co.yahoo.adssearchapi.v9.model.AdGroupServiceBiddingKeywordCpcRange;
import jp.co.yahoo.adssearchapi.v9.model.AdGroupServiceContainsLabelId;
import jp.co.yahoo.adssearchapi.v9.model.AdGroupServiceCreatedDateRange;
...
public class AdGroupServiceSelector {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, adGroupIds, portfolioBiddingIds, campaignIds, containsLabelId, labelIds, numberResults, startIndex, userStatuses, createdDateRange, biddingKeywordCpcRange);
  }
