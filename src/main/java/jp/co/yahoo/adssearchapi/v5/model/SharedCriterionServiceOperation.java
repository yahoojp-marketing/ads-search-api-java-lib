...
public class SharedCriterionServiceOperation   {
  ...
  @Valid
  private JsonNullable<List<SharedCriterion>> operand = JsonNullable.undefined();
  ...
  */
  ...
  @Valid
@Size(min=1,max=1000) 
  public JsonNullable<List<SharedCriterion>> getOperand() {
    return operand;
  }

  public void setOperand(JsonNullable<List<SharedCriterion>> operand) {
