 ...
 */
public enum FeedItemServiceTrademarkStatus {
  ...
  FeedItemServiceTrademarkStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static FeedItemServiceTrademarkStatus fromValue(String value) {
    for (FeedItemServiceTrademarkStatus b : FeedItemServiceTrademarkStatus.values()) {
