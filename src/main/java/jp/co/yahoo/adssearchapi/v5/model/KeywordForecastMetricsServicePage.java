...
public class KeywordForecastMetricsServicePage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<KeywordForecastMetricsServiceValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<KeywordForecastMetricsServiceValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<KeywordForecastMetricsServiceValue>> values) {
    this.values = values;
  }
