...
import jp.co.yahoo.adssearchapi.v5.model.AdGroupBidMultiplierServiceReturnValue;
...
public class AdGroupBidMultiplierServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<AdGroupBidMultiplierServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<AdGroupBidMultiplierServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<AdGroupBidMultiplierServiceReturnValue> rval) {
    this.rval = rval;
  }
