...
import jp.co.yahoo.adssearchapi.v5.model.BudgetOrderServiceReturnValue;
...
public class BudgetOrderServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<BudgetOrderServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<BudgetOrderServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<BudgetOrderServiceReturnValue> rval) {
    this.rval = rval;
  }
