...
import jp.co.yahoo.adssearchapi.v5.model.LabelServicePage;
...
public class LabelServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<LabelServicePage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<LabelServicePage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<LabelServicePage> rval) {
    this.rval = rval;
  }
