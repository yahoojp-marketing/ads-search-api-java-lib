...
public class AppLinkServiceOperation   {
  ...
  @Valid
  private JsonNullable<List<AppLink>> operand = JsonNullable.undefined();
  ...
  */
  ...
  @Valid
@Size(min=1,max=10) 
  public JsonNullable<List<AppLink>> getOperand() {
    return operand;
  }

  public void setOperand(JsonNullable<List<AppLink>> operand) {
