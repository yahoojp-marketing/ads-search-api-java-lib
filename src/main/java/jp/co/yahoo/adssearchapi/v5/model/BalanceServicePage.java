...
import jp.co.yahoo.adssearchapi.v5.model.BalanceServiceValue;
...
public class BalanceServicePage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<BalanceServiceValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<BalanceServiceValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<BalanceServiceValue>> values) {
    this.values = values;
  }
