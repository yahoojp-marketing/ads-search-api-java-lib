...
import jp.co.yahoo.adssearchapi.v5.model.AdGroupWebpageServiceWebpageCondition;
...
public class AdGroupWebpageServiceWebpageParameter   {
  ...
  @Valid
  private JsonNullable<List<AdGroupWebpageServiceWebpageCondition>> conditions = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<AdGroupWebpageServiceWebpageCondition>> getConditions() {
    return conditions;
  }

  public void setConditions(JsonNullable<List<AdGroupWebpageServiceWebpageCondition>> conditions) {
