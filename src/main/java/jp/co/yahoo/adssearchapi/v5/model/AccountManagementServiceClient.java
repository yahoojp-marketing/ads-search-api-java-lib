...
import jp.co.yahoo.adssearchapi.v5.model.AccountManagementServiceEnterpriseType;
import jp.co.yahoo.adssearchapi.v5.model.AccountManagementServiceEnterpriseTypePosition;
import jp.co.yahoo.adssearchapi.v5.model.AccountManagementServicePrefectureCode;
import jp.co.yahoo.adssearchapi.v5.model.AccountManagementServiceUrlType;
...
public class AccountManagementServiceClient   {
  ...
  private JsonNullable<String> building = JsonNullable.undefined();

  @JsonProperty("city")
  private JsonNullable<String> city = JsonNullable.undefined();

  @JsonProperty("clientPersonName")
  private JsonNullable<String> clientPersonName = JsonNullable.undefined();

  @JsonProperty("companyName")
  private JsonNullable<String> companyName = JsonNullable.undefined();

  @JsonProperty("companyNameKana")
  private JsonNullable<String> companyNameKana = JsonNullable.undefined();

  @JsonProperty("enterpriseType")
  private JsonNullable<AccountManagementServiceEnterpriseType> enterpriseType = JsonNullable.undefined();

  @JsonProperty("enterpriseTypePosition")
  private JsonNullable<AccountManagementServiceEnterpriseTypePosition> enterpriseTypePosition = JsonNullable.undefined();

  @JsonProperty("phoneNumber")
  private JsonNullable<String> phoneNumber = JsonNullable.undefined();

  @JsonProperty("prefectureCode")
  private JsonNullable<AccountManagementServicePrefectureCode> prefectureCode = JsonNullable.undefined();
  ...
  private JsonNullable<AccountManagementServiceUrlType> urlType = JsonNullable.undefined();

  @JsonProperty("zip")
  private JsonNullable<String> zip = JsonNullable.undefined();

  public AccountManagementServiceClient building(String building) {
    this.building = JsonNullable.of(building);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getBuilding() {
    return building;
  }

  public void setBuilding(JsonNullable<String> building) {
  ...
  */
  ...
  public AccountManagementServiceClient clientPersonName(String clientPersonName) {
    this.clientPersonName = JsonNullable.of(clientPersonName);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getClientPersonName() {
    return clientPersonName;
  }

  public void setClientPersonName(JsonNullable<String> clientPersonName) {
  ...
  */
  ...
  public AccountManagementServiceClient companyNameKana(String companyNameKana) {
    this.companyNameKana = JsonNullable.of(companyNameKana);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getCompanyNameKana() {
    return companyNameKana;
  }

  public void setCompanyNameKana(JsonNullable<String> companyNameKana) {
  ...
  public AccountManagementServiceClient enterpriseType(AccountManagementServiceEnterpriseType enterpriseType) {
    this.enterpriseType = JsonNullable.of(enterpriseType);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<AccountManagementServiceEnterpriseType> getEnterpriseType() {
    return enterpriseType;
  }

  public void setEnterpriseType(JsonNullable<AccountManagementServiceEnterpriseType> enterpriseType) {
  ...
  public AccountManagementServiceClient enterpriseTypePosition(AccountManagementServiceEnterpriseTypePosition enterpriseTypePosition) {
    this.enterpriseTypePosition = JsonNullable.of(enterpriseTypePosition);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<AccountManagementServiceEnterpriseTypePosition> getEnterpriseTypePosition() {
    return enterpriseTypePosition;
  }

  public void setEnterpriseTypePosition(JsonNullable<AccountManagementServiceEnterpriseTypePosition> enterpriseTypePosition) {
...
@Pattern(regexp="^\\d{1,5}-\\d{1,5}-\\d{1,5}$") 
  ...
  public AccountManagementServiceClient prefectureCode(AccountManagementServicePrefectureCode prefectureCode) {
    this.prefectureCode = JsonNullable.of(prefectureCode);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<AccountManagementServicePrefectureCode> getPrefectureCode() {
    return prefectureCode;
  }

  public void setPrefectureCode(JsonNullable<AccountManagementServicePrefectureCode> prefectureCode) {
  ...
  */
  ...
  public AccountManagementServiceClient urlType(AccountManagementServiceUrlType urlType) {
    this.urlType = JsonNullable.of(urlType);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<AccountManagementServiceUrlType> getUrlType() {
    return urlType;
  }

  public void setUrlType(JsonNullable<AccountManagementServiceUrlType> urlType) {
...
@Pattern(regexp="^\\d{3}-\\d{4}$") 
  public JsonNullable<String> getZip() {
    return zip;
  }

  public void setZip(JsonNullable<String> zip) {
    this.zip = zip;
  }
