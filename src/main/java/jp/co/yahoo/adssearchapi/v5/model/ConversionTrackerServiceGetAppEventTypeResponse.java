...
import jp.co.yahoo.adssearchapi.v5.model.ConversionTrackerServiceAppEventTypePage;
...
public class ConversionTrackerServiceGetAppEventTypeResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<ConversionTrackerServiceAppEventTypePage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<ConversionTrackerServiceAppEventTypePage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<ConversionTrackerServiceAppEventTypePage> rval) {
    this.rval = rval;
  }
