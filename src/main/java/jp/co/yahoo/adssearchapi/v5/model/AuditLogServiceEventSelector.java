...
public class AuditLogServiceEventSelector   {
  ...
  private JsonNullable<String> entityType = JsonNullable.undefined();

  @JsonProperty("eventTypes")
  @Valid
  private JsonNullable<List<AuditLogServiceEventTypes>> eventTypes = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<String> getEntityType() {
    return entityType;
  }

  public void setEntityType(JsonNullable<String> entityType) {
    this.entityType = entityType;
  }

  public AuditLogServiceEventSelector eventTypes(List<AuditLogServiceEventTypes> eventTypes) {
    this.eventTypes = JsonNullable.of(eventTypes);
    return this;
  }
  ...
  public AuditLogServiceEventSelector addEventTypesItem(AuditLogServiceEventTypes eventTypesItem) {
    if (this.eventTypes == null || !this.eventTypes.isPresent()) {
      this.eventTypes = JsonNullable.of(new ArrayList<>());
    }
  ...
  */
  ...
  public JsonNullable<List<AuditLogServiceEventTypes>> getEventTypes() {
    return eventTypes;
  }

  public void setEventTypes(JsonNullable<List<AuditLogServiceEventTypes>> eventTypes) {
