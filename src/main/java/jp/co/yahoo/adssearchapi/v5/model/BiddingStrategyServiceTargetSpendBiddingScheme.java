...
@JsonPropertyOrder({
  BiddingStrategyServiceTargetSpendBiddingScheme.JSON_PROPERTY_BID_CEILING
})
@JsonTypeName("BiddingStrategyServiceTargetSpendBiddingScheme")
...
public class BiddingStrategyServiceTargetSpendBiddingScheme {
  ...
  public BiddingStrategyServiceTargetSpendBiddingScheme() { 
  }
