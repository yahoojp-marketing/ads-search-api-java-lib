...
public class KeywordForecastMetrics   {
  ...
  private JsonNullable<Double> averageCpc = JsonNullable.undefined();
  ...
  */
  ...
  public KeywordForecastMetrics averageCpc(Double averageCpc) {
    this.averageCpc = JsonNullable.of(averageCpc);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<Double> getAverageCpc() {
    return averageCpc;
  }

  public void setAverageCpc(JsonNullable<Double> averageCpc) {
