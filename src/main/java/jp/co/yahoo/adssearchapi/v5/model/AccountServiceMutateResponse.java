...
import jp.co.yahoo.adssearchapi.v5.model.AccountServiceReturnValue;
...
public class AccountServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<AccountServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<AccountServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<AccountServiceReturnValue> rval) {
    this.rval = rval;
  }
