...
public class PageFeedItemServiceDownloadJobValue   {
  ...
  @JsonProperty("job")
  private JsonNullable<PageFeedItemServiceDownloadJob> job = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<PageFeedItemServiceDownloadJob> getJob() {
    return job;
  }

  public void setJob(JsonNullable<PageFeedItemServiceDownloadJob> job) {
    this.job = job;
  }
