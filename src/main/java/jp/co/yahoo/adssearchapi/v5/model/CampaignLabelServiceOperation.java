...
public class CampaignLabelServiceOperation   {
  ...
  @Valid
  private JsonNullable<List<CampaignLabel>> operand = JsonNullable.undefined();
  ...
  */
  ...
  @Valid
@Size(min=1,max=2000) 
  public JsonNullable<List<CampaignLabel>> getOperand() {
    return operand;
  }

  public void setOperand(JsonNullable<List<CampaignLabel>> operand) {
