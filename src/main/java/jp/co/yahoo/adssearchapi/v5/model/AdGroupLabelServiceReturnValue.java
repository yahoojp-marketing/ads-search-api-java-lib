...
import jp.co.yahoo.adssearchapi.v5.model.AdGroupLabelServiceValue;
...
public class AdGroupLabelServiceReturnValue   {
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<AdGroupLabelServiceValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<AdGroupLabelServiceValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<AdGroupLabelServiceValue>> values) {
    this.values = values;
  }
