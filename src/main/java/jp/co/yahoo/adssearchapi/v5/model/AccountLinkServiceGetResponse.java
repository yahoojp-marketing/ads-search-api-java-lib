...
import jp.co.yahoo.adssearchapi.v5.model.AccountLinkServicePage;
...
public class AccountLinkServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<AccountLinkServicePage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<AccountLinkServicePage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<AccountLinkServicePage> rval) {
    this.rval = rval;
  }
