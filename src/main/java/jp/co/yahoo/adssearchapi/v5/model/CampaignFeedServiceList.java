...
public class CampaignFeedServiceList   {
  ...
  @Valid
  private JsonNullable<List<CampaignFeed>> campaignFeed = JsonNullable.undefined();
  ...
  */
  ...
  public CampaignFeedServiceList campaignFeed(List<CampaignFeed> campaignFeed) {
    this.campaignFeed = JsonNullable.of(campaignFeed);
    return this;
  }

  public CampaignFeedServiceList addCampaignFeedItem(CampaignFeed campaignFeedItem) {
    if (this.campaignFeed == null || !this.campaignFeed.isPresent()) {
      this.campaignFeed = JsonNullable.of(new ArrayList<>());
    }
    this.campaignFeed.get().add(campaignFeedItem);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<List<CampaignFeed>> getCampaignFeed() {
    return campaignFeed;
  }

  public void setCampaignFeed(JsonNullable<List<CampaignFeed>> campaignFeed) {
