...
public class CampaignServiceTargetingSetting   {
  ...
  private JsonNullable<CampaignServiceTargetAll> targetAll = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<CampaignServiceTargetAll> getTargetAll() {
    return targetAll;
  }

  public void setTargetAll(JsonNullable<CampaignServiceTargetAll> targetAll) {
