...
import jp.co.yahoo.adssearchapi.v5.model.AdGroupCriterionLabelServiceReturnValue;
...
public class AdGroupCriterionLabelServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<AdGroupCriterionLabelServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<AdGroupCriterionLabelServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<AdGroupCriterionLabelServiceReturnValue> rval) {
    this.rval = rval;
  }
