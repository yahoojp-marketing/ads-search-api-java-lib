...
import jp.co.yahoo.adssearchapi.v5.model.PageFeedItemServiceReturnValue;
...
public class PageFeedItemServicePage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<PageFeedItemServiceReturnValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<PageFeedItemServiceReturnValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<PageFeedItemServiceReturnValue>> values) {
    this.values = values;
  }
