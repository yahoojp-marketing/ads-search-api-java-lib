...
import jp.co.yahoo.adssearchapi.v5.model.CampaignTargetServiceReturnValue;
...
public class CampaignTargetServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<CampaignTargetServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<CampaignTargetServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<CampaignTargetServiceReturnValue> rval) {
    this.rval = rval;
  }
