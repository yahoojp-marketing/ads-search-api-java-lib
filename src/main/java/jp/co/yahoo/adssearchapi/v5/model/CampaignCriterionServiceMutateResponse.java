...
public class CampaignCriterionServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<CampaignCriterionServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<CampaignCriterionServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<CampaignCriterionServiceReturnValue> rval) {
    this.rval = rval;
  }
