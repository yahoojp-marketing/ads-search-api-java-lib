...
import jp.co.yahoo.adssearchapi.v5.model.DictionaryServiceAppLinkVendorValue;
...
public class DictionaryServiceAppLinkVendorPage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<DictionaryServiceAppLinkVendorValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<DictionaryServiceAppLinkVendorValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<DictionaryServiceAppLinkVendorValue>> values) {
    this.values = values;
  }
