...
import jp.co.yahoo.adssearchapi.v5.model.PageFeedItem;
...
public class PageFeedItemServiceReturnValue   {
  ...
  private JsonNullable<PageFeedItem> pageFeedItem = JsonNullable.undefined();
  ...
  */
  ...
  public PageFeedItemServiceReturnValue pageFeedItem(PageFeedItem pageFeedItem) {
    this.pageFeedItem = JsonNullable.of(pageFeedItem);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<PageFeedItem> getPageFeedItem() {
    return pageFeedItem;
  }

  public void setPageFeedItem(JsonNullable<PageFeedItem> pageFeedItem) {
