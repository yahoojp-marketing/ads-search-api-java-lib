...
public class AdGroupServiceCustomParameters   {
  ...
  private JsonNullable<AdGroupServiceIsRemove> isRemove = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<AdGroupServiceIsRemove> getIsRemove() {
    return isRemove;
  }

  public void setIsRemove(JsonNullable<AdGroupServiceIsRemove> isRemove) {
