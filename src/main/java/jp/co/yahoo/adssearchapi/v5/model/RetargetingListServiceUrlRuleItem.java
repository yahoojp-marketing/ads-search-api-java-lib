...
public class RetargetingListServiceUrlRuleItem   {
  ...
  private JsonNullable<RetargetingListServiceUrlRuleKey> urlRuleKey = JsonNullable.undefined();

  public RetargetingListServiceUrlRuleItem urlRuleKey(RetargetingListServiceUrlRuleKey urlRuleKey) {
    this.urlRuleKey = JsonNullable.of(urlRuleKey);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<RetargetingListServiceUrlRuleKey> getUrlRuleKey() {
    return urlRuleKey;
  }

  public void setUrlRuleKey(JsonNullable<RetargetingListServiceUrlRuleKey> urlRuleKey) {
