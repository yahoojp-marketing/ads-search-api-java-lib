...
import jp.co.yahoo.adssearchapi.v5.model.Label;
...
public class LabelServiceOperation   {
  ...
  @Valid
  private JsonNullable<List<Label>> operand = JsonNullable.undefined();
  ...
  */
  ...
  @Valid
@Size(min=1,max=2000) 
  public JsonNullable<List<Label>> getOperand() {
    return operand;
  }

  public void setOperand(JsonNullable<List<Label>> operand) {
