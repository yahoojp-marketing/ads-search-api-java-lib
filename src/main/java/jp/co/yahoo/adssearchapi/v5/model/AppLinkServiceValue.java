...
public class AppLinkServiceValue   {
  ...
  private JsonNullable<AppLink> appLink = JsonNullable.undefined();
  ...
  public AppLinkServiceValue appLink(AppLink appLink) {
    this.appLink = JsonNullable.of(appLink);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<AppLink> getAppLink() {
    return appLink;
  }

  public void setAppLink(JsonNullable<AppLink> appLink) {
