...
import jp.co.yahoo.adssearchapi.v5.model.AdGroupLabel;
...
public class AdGroupLabelServiceOperation   {
  ...
  @Valid
  private JsonNullable<List<AdGroupLabel>> operand = JsonNullable.undefined();
  ...
  */
  ...
  @Valid
@Size(min=1,max=2000) 
  public JsonNullable<List<AdGroupLabel>> getOperand() {
    return operand;
  }

  public void setOperand(JsonNullable<List<AdGroupLabel>> operand) {
