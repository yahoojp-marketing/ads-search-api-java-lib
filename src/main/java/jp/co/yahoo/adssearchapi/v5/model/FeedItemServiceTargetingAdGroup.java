...
public class FeedItemServiceTargetingAdGroup   {
  ...
  private JsonNullable<Long> targetingAdGroupId = JsonNullable.undefined();

  public FeedItemServiceTargetingAdGroup targetingAdGroupId(Long targetingAdGroupId) {
    this.targetingAdGroupId = JsonNullable.of(targetingAdGroupId);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<Long> getTargetingAdGroupId() {
    return targetingAdGroupId;
  }

  public void setTargetingAdGroupId(JsonNullable<Long> targetingAdGroupId) {
