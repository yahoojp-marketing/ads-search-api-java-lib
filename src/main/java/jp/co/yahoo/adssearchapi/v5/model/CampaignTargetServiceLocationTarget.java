...
import jp.co.yahoo.adssearchapi.v5.model.CampaignTargetServiceTargetingStatus;
...
public class CampaignTargetServiceLocationTarget   {
  ...
  private JsonNullable<String> cityNameEN = JsonNullable.undefined();

  @JsonProperty("cityNameJA")
  private JsonNullable<String> cityNameJA = JsonNullable.undefined();
  ...
  private JsonNullable<String> provinceNameEN = JsonNullable.undefined();

  @JsonProperty("provinceNameJA")
  private JsonNullable<String> provinceNameJA = JsonNullable.undefined();

  @JsonProperty("targetingStatus")
  private JsonNullable<CampaignTargetServiceTargetingStatus> targetingStatus = JsonNullable.undefined();

  public CampaignTargetServiceLocationTarget cityNameEN(String cityNameEN) {
    this.cityNameEN = JsonNullable.of(cityNameEN);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getCityNameEN() {
    return cityNameEN;
  }

  public void setCityNameEN(JsonNullable<String> cityNameEN) {
    this.cityNameEN = cityNameEN;
  }

  public CampaignTargetServiceLocationTarget cityNameJA(String cityNameJA) {
    this.cityNameJA = JsonNullable.of(cityNameJA);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getCityNameJA() {
    return cityNameJA;
  }

  public void setCityNameJA(JsonNullable<String> cityNameJA) {
  ...
  */
  ...
  public CampaignTargetServiceLocationTarget provinceNameEN(String provinceNameEN) {
    this.provinceNameEN = JsonNullable.of(provinceNameEN);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getProvinceNameEN() {
    return provinceNameEN;
  }

  public void setProvinceNameEN(JsonNullable<String> provinceNameEN) {
    this.provinceNameEN = provinceNameEN;
  }

  public CampaignTargetServiceLocationTarget provinceNameJA(String provinceNameJA) {
    this.provinceNameJA = JsonNullable.of(provinceNameJA);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<String> getProvinceNameJA() {
    return provinceNameJA;
  }

  public void setProvinceNameJA(JsonNullable<String> provinceNameJA) {
  ...
  public CampaignTargetServiceLocationTarget targetingStatus(CampaignTargetServiceTargetingStatus targetingStatus) {
    this.targetingStatus = JsonNullable.of(targetingStatus);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<CampaignTargetServiceTargetingStatus> getTargetingStatus() {
    return targetingStatus;
  }

  public void setTargetingStatus(JsonNullable<CampaignTargetServiceTargetingStatus> targetingStatus) {
