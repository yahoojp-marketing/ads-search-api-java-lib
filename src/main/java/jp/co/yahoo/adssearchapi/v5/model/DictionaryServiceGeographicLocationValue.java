...
import jp.co.yahoo.adssearchapi.v5.model.DictionaryServiceGeographicLocation;
...
public class DictionaryServiceGeographicLocationValue   {
  ...
  private JsonNullable<DictionaryServiceGeographicLocation> geographicLocation = JsonNullable.undefined();
  ...
  */
  ...
  public DictionaryServiceGeographicLocationValue geographicLocation(DictionaryServiceGeographicLocation geographicLocation) {
    this.geographicLocation = JsonNullable.of(geographicLocation);
    return this;
  }
  ...
  */
  ...
  public JsonNullable<DictionaryServiceGeographicLocation> getGeographicLocation() {
    return geographicLocation;
  }

  public void setGeographicLocation(JsonNullable<DictionaryServiceGeographicLocation> geographicLocation) {
