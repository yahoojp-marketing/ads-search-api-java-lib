...
import jp.co.yahoo.adssearchapi.v5.model.DictionaryServiceDisapprovalReasonValue;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">DictionaryServiceDisapprovalReasonPageオブジェクトは、 EditorialReason一覧を格納するコンテナです。</div> <div lang=\"en\">DictionaryServiceDisapprovalReasonPage object is a container for EditorialReason list</div> ")
...
public class DictionaryServiceDisapprovalReasonPage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<DictionaryServiceDisapprovalReasonValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<DictionaryServiceDisapprovalReasonValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<DictionaryServiceDisapprovalReasonValue>> values) {
    this.values = values;
  }
