...
public class AdGroupServiceBid   {
  ...
  private JsonNullable<AdGroupServiceBidSource> bidSource = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<AdGroupServiceBidSource> getBidSource() {
    return bidSource;
  }

  public void setBidSource(JsonNullable<AdGroupServiceBidSource> bidSource) {
