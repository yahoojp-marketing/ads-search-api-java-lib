...
public class ReportDefinitionServiceOperation   {
  ...
  @Valid
  private JsonNullable<List<ReportDefinition>> operand = JsonNullable.undefined();
  ...
  */
  ...
  @Valid
@Size(min=1,max=30) 
  public JsonNullable<List<ReportDefinition>> getOperand() {
    return operand;
  }

  public void setOperand(JsonNullable<List<ReportDefinition>> operand) {
