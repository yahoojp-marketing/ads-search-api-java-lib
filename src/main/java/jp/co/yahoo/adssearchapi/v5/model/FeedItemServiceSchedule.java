...
public class FeedItemServiceSchedule   {
  ...
  private JsonNullable<FeedItemServiceDayOfWeek> dayOfWeek = JsonNullable.undefined();

  @JsonProperty("endHour")
  private JsonNullable<Long> endHour = JsonNullable.undefined();

  @JsonProperty("endMinute")
  private JsonNullable<FeedItemServiceMinuteOfHour> endMinute = JsonNullable.undefined();

  @JsonProperty("startHour")
  private JsonNullable<Long> startHour = JsonNullable.undefined();

  @JsonProperty("startMinute")
  private JsonNullable<FeedItemServiceMinuteOfHour> startMinute = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<FeedItemServiceDayOfWeek> getDayOfWeek() {
    return dayOfWeek;
  }

  public void setDayOfWeek(JsonNullable<FeedItemServiceDayOfWeek> dayOfWeek) {
  ...
  */
  ...
  public JsonNullable<Long> getEndHour() {
    return endHour;
  }

  public void setEndHour(JsonNullable<Long> endHour) {
  ...
  */
  ...
  public JsonNullable<FeedItemServiceMinuteOfHour> getEndMinute() {
    return endMinute;
  }

  public void setEndMinute(JsonNullable<FeedItemServiceMinuteOfHour> endMinute) {
  ...
  */
  ...
  public JsonNullable<Long> getStartHour() {
    return startHour;
  }

  public void setStartHour(JsonNullable<Long> startHour) {
  ...
  */
  ...
  public JsonNullable<FeedItemServiceMinuteOfHour> getStartMinute() {
    return startMinute;
  }

  public void setStartMinute(JsonNullable<FeedItemServiceMinuteOfHour> startMinute) {
