...
public class AdGroupServiceOperation   {
  ...
  @Valid
  private JsonNullable<List<AdGroup>> operand = JsonNullable.undefined();
  ...
  */
  ...
  @Valid
@Size(min=1,max=2000) 
  public JsonNullable<List<AdGroup>> getOperand() {
    return operand;
  }

  public void setOperand(JsonNullable<List<AdGroup>> operand) {
