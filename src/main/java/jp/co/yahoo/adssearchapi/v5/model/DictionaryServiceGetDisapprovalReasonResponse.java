...
import jp.co.yahoo.adssearchapi.v5.model.DictionaryServiceDisapprovalReasonPage;
...
public class DictionaryServiceGetDisapprovalReasonResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<DictionaryServiceDisapprovalReasonPage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<DictionaryServiceDisapprovalReasonPage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<DictionaryServiceDisapprovalReasonPage> rval) {
    this.rval = rval;
  }
