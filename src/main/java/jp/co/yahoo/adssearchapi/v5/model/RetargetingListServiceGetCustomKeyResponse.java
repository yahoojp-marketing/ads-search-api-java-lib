...
import jp.co.yahoo.adssearchapi.v5.model.RetargetingListServiceCustomKeyPage;
...
public class RetargetingListServiceGetCustomKeyResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<RetargetingListServiceCustomKeyPage> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<RetargetingListServiceCustomKeyPage> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<RetargetingListServiceCustomKeyPage> rval) {
    this.rval = rval;
  }
