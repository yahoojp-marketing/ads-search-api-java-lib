...
import jp.co.yahoo.adssearchapi.v5.model.AccountSharedServiceReturnValue;
...
public class AccountSharedServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<AccountSharedServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<AccountSharedServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<AccountSharedServiceReturnValue> rval) {
    this.rval = rval;
  }
