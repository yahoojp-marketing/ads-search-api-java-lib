...
public class CampaignRetargetingListServiceMutateResponse   {
  ...
  @JsonProperty("rval")
  private JsonNullable<CampaignRetargetingListServiceReturnValue> rval = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<CampaignRetargetingListServiceReturnValue> getRval() {
    return rval;
  }

  public void setRval(JsonNullable<CampaignRetargetingListServiceReturnValue> rval) {
    this.rval = rval;
  }
