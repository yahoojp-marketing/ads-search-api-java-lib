...
import jp.co.yahoo.adssearchapi.v5.model.KeywordPlanIdeaServiceValue;
...
public class KeywordPlanIdeaServicePage   {
  ...
  @JsonProperty("values")
  @Valid
  private JsonNullable<List<KeywordPlanIdeaServiceValue>> values = JsonNullable.undefined();
  ...
  */
  ...
  public JsonNullable<List<KeywordPlanIdeaServiceValue>> getValues() {
    return values;
  }

  public void setValues(JsonNullable<List<KeywordPlanIdeaServiceValue>> values) {
    this.values = values;
  }
