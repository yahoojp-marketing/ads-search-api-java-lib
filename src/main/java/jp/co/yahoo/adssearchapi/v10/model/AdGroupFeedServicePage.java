...
import jp.co.yahoo.adssearchapi.v10.model.AdGroupFeedServiceValue;
...
@JsonPropertyOrder({
  AdGroupFeedServicePage.JSON_PROPERTY_TOTAL_NUM_ENTRIES,
  AdGroupFeedServicePage.JSON_PROPERTY_VALUES
})
@JsonTypeName("AdGroupFeedServicePage")
