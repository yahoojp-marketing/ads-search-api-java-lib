...
import jp.co.yahoo.adssearchapi.v10.model.AdGroupServiceBiddingKeywordCpcRange;
import jp.co.yahoo.adssearchapi.v10.model.AdGroupServiceCreatedDateRange;
...
public class AdGroupServiceSelector {
  ...
  **/
  ...
  public AdGroupServiceSelector containsLabel(Boolean containsLabel) {
   ...
   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt;ラベルデータ取得フラグです。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AdGroupServiceContainsLabel object describes acquisition flag of label data.&lt;/div&gt; 
   * @return containsLabel
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\">ラベルデータ取得フラグです。</div> <div lang=\"en\">AdGroupServiceContainsLabel object describes acquisition flag of label data.</div> ")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, adGroupIds, portfolioBiddingIds, campaignIds, containsLabel, labelIds, numberResults, startIndex, userStatuses, createdDateRange, biddingKeywordCpcRange);
  }
