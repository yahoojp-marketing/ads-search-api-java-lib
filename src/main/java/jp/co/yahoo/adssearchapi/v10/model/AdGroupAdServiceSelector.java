...
import jp.co.yahoo.adssearchapi.v10.model.AdGroupAdServiceCreatedDateRange;
...
public class AdGroupAdServiceSelector {
  ...
  **/
  ...
  public AdGroupAdServiceSelector containsLabel(Boolean containsLabel) {
   ...
   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt;ラベルデータ取得フラグです。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AdGroupAdServiceContainsLabel object describes acquisition flag of label data.&lt;/div&gt; 
   * @return containsLabel
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\">ラベルデータ取得フラグです。</div> <div lang=\"en\">AdGroupAdServiceContainsLabel object describes acquisition flag of label data.</div> ")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, campaignIds, adGroupIds, adIds, adTypes, approvalStatuses, userStatuses, containsLabel, labelIds, createdDateRange, numberResults, startIndex);
  }
