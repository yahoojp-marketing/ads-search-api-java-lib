...
/**
 * &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AdGroupAdServiceCustomParametersは、カスタムパラメータの設定を表します。&lt;br&gt; ADD時、このフィールドは省略可能となります。&lt;br&gt; ※reviewCustomParameters配下の場合、このフィールドはリクエストの際に無視され、レスポンスの際は返却されません。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AdGroupAdServiceCustomParameters displays the setting of custom parameters.&lt;br&gt; This field is optional in ADD operation.&lt;br&gt; *Under reviewCustomParameters, this field is ignored in the request and not returned in the response.&lt;/div&gt; 
 */
