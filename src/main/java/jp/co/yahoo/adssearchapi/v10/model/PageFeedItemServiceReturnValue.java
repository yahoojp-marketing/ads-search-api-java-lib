...
import jp.co.yahoo.adssearchapi.v10.model.PageFeedItem;
...
@JsonPropertyOrder({
  PageFeedItemServiceReturnValue.JSON_PROPERTY_ERRORS,
  PageFeedItemServiceReturnValue.JSON_PROPERTY_OPERATION_SUCCEEDED,
  PageFeedItemServiceReturnValue.JSON_PROPERTY_PAGE_FEED_ITEM
})
@JsonTypeName("PageFeedItemServiceReturnValue")
...
public class PageFeedItemServiceReturnValue {
  ...
  public static final String JSON_PROPERTY_PAGE_FEED_ITEM = "pageFeedItem";
  private PageFeedItem pageFeedItem;

  public PageFeedItemServiceReturnValue() { 
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_PAGE_FEED_ITEM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
