...
import jp.co.yahoo.adssearchapi.v13.model.AccountCustomizerServiceApprovalStatus;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">AccountCustomizerオブジェクトは、アカウントとカスタマイザー属性間の設定情報を格納します。</div> <div lang=\"en\">AccountCustomizer object contains the configuration information between the account and the customizer attribute.</div> ")
@JsonPropertyOrder({
