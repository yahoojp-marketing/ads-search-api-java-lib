 ...
 */
@ApiModel(description = "<div lang=\"ja\">CampaignBudgetオブジェクトは、共有予算の情報を格納します。</div> <div lang=\"en\">CampaignBudget object contains the information of CampaignBudget.</div> ")
@JsonPropertyOrder({
...
public class CampaignBudget {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\">共有予算IDです。<br> このフィールドは、SETおよびREMOVE時に必須となり、ADD時に無視されます。</div> <div lang=\"en\">CampaignBudget ID.<br>This field is required in SET and REMOVE operation, and will be ignored in ADD operation.</div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\">共有予算名です。<br>このフィールドは、ADD時に必須となり、SET時に省略可能となります。</div> <div lang=\"en\">CampaignBudget name.<br>This field is required in ADD operation, and will be optional in SET operation.</div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\">共有予算の金額です。<br> このフィールドは、ADD時は必須となり、SET時は省略可能となります。</div> <div lang=\"en\">Amount of budget of Campaign.<br> This field is required in ADD operation, and is optional in SET operation.</div> ")
