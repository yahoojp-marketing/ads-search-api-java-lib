...
public class CampaignRetargetingListServiceSelector {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "<div lang=\"ja\">アカウントIDです。</div> <div lang=\"en\">Search condition: Account ID.</div> ")
  ...
  **/
  ...
  @ApiModelProperty(value = "<div lang=\"ja\">キャンペーンIDです。</div> <div lang=\"en\">Search condition: Campaign ID.</div> ")
