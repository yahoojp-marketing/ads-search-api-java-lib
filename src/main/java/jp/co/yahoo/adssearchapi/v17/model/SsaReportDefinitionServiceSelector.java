 ...
 */
@ApiModel(description = "<div lang=\"ja\">SsaReportDefinitionServiceSelectorオブジェクトは、操作の対象とするレポートです。</div> <div lang=\"en\">SsaReportDefinitionServiceSelector is a detail of requested report.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("SsaReportDefinitionServiceSelector")
...
public class SsaReportDefinitionServiceSelector {
  ...
  private List<SsaReportDefinitionServiceReportJobStatus> reportJobStatuses = null;

  public static final String JSON_PROPERTY_REPORT_TYPES = "reportTypes";
  private List<SsaReportDefinitionServiceReportType> reportTypes = null;
