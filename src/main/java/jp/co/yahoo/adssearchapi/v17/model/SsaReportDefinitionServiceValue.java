 ...
 */
@ApiModel(description = "<div lang=\"ja\">SsaReportDefinitionServiceValueオブジェクトは、処理結果を含むレポートの情報を表します。</div> <div lang=\"en\">SsaReportDefinitionServiceValue is an information of the report including operation result.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("SsaReportDefinitionServiceValue")
