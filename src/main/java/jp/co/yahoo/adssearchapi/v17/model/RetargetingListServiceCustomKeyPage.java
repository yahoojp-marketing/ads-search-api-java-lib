 ...
 */
@ApiModel(description = "<div lang=\"ja\">RetargetingListServiceCustomKeyPageは、ターゲットリストのカスタムキー情報を保持するオブジェクトです。</div> <div lang=\"en\">RetargetingListServiceCustomKeyPage is an object that holds custom key information of target list.</div> ")
@JsonPropertyOrder({
