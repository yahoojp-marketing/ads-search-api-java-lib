 ...
 */
@ApiModel(description = "<div lang=\"ja\">AbTestServiceValueオブジェクトは、処理結果を含むA/Bテストに関する情報を表します。</div> <div lang=\"en\">AbTestServiceValue serves the information of AbTest including operation results.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("AbTestServiceValue")
