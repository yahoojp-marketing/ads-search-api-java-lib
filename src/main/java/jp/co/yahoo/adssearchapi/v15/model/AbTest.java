...
import jp.co.yahoo.adssearchapi.v15.model.AbTestServiceCampaignIsDeleteFlg;
import jp.co.yahoo.adssearchapi.v15.model.AbTestServiceCampaignTestType;
import jp.co.yahoo.adssearchapi.v15.model.AbTestServiceCampaignUserStatus;
import jp.co.yahoo.adssearchapi.v15.model.AbTestServiceIsRemoveFlg;
import jp.co.yahoo.adssearchapi.v15.model.AbTestServiceStatus;
...
public class AbTest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> A/Bテスト名です。<br> このフィールドは、ADD時は必須となり、SET時は省略可能となります。<br> ※256文字以内になります。 </div> <div lang=\"en\"> A/B test name.<br> This field is required in ADD operation, and will be optional in SET operation.<br> *Up to 128 characters. </div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> 説明文です。<br> ADDおよびSET時、このフィールドは省略可能となります。<br> ※512文字以内になります。 </div> <div lang=\"en\"> Description text.<br> This field is optional in ADD and SET operation.<br> *Up to 512 characters. </div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> A/Bテストのサフィックスです。<br> ADD時、このフィールドは必須となります。<br> ※16文字以内になります。 </div> <div lang=\"en\"> suffix text.<br> This field is required in ADD operation.<br> *Up to 16 characters. </div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> キャンペーンAのキャンペーンIDです。<br> ADD時、このフィールドは必須となります。 </div> <div lang=\"en\"> Campaign ID of Campaign A.<br> This field is required in ADD operation. </div> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> キャンペーンBのキャンペーンIDです。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。 </div> <div lang=\"en\"> Campaign ID of Campaign B.<br> Although this field will be returned in the response, it will be ignored on input. </div> ")
  ...
  **/
  ...
  public AbTest addErrorsItem(String errorsItem) {
   ...
   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt; エラー内容です。&lt;br&gt; このフィールドはリクエストの際には無視されます。&lt;br&gt; 以下エラー詳細になります。&lt;br&gt; - ENTITY_USE_AD_CUSTOMIZER: アドカスタマイザーを利用した広告が含まれるキャンペーンはテスト元のキャンペーンに設定できません。&lt;br&gt; - ENTITY_UNDER_REVIEW: 審査中のアイテムが含まれるためA/Bテストを作成できませんでした。&lt;br&gt; - CAMPAIGN_OVER_LIMIT: キャンペーンの作成上限数を超えています。&lt;br&gt; - KEYWORD_OVER_LIMIT: キーワードの作成上限数を超えています。&lt;br&gt; - AD_OVER_LIMIT: 広告の作成上限数を超えています。&lt;br&gt; - SYSTEM_ERROR_OCCURRED: システムエラーが発生しました。&lt;br&gt; 詳細は以下のヘルプを参照してください。&lt;br&gt; ・&lt;a href&#x3D;\&quot;https://ads-help.yahoo-net.jp/s/article/H000053491?language&#x3D;ja\&quot;&gt;A/Bテストについて【検索広告】&lt;/a&gt;&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Errors.&lt;br&gt; This field will be ignored on input.&lt;br&gt; Error details.&lt;br&gt; - ENTITY_USE_AD_CUSTOMIZER: You can&#39;t set up a campaign that contains ads using the ad customizer as the original campaign.&lt;br&gt; - ENTITY_UNDER_REVIEW: Can&#39;t create an A/B test. The campaign contains elements under review.&lt;br&gt; - CAMPAIGN_OVER_LIMIT: You already have the maximum number of campaigns.&lt;br&gt; - KEYWORD_OVER_LIMIT: You already have the maximum number of keywords.&lt;br&gt; - AD_OVER_LIMIT: You already have the maximum number of ads.&lt;br&gt; - SYSTEM_ERROR_OCCURRED: A system error has occurred.&lt;br&gt; See also the help below.&lt;br&gt; * &lt;a href&#x3D;\&quot;https://ads-help.yahoo-net.jp/s/article/H000053491?language&#x3D;en_US\&quot;&gt;A/B test [Search Ads]&lt;/a&gt;&lt;/div&gt; 
   * @return errors
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> エラー内容です。<br> このフィールドはリクエストの際には無視されます。<br> 以下エラー詳細になります。<br> - ENTITY_USE_AD_CUSTOMIZER: アドカスタマイザーを利用した広告が含まれるキャンペーンはテスト元のキャンペーンに設定できません。<br> - ENTITY_UNDER_REVIEW: 審査中のアイテムが含まれるためA/Bテストを作成できませんでした。<br> - CAMPAIGN_OVER_LIMIT: キャンペーンの作成上限数を超えています。<br> - KEYWORD_OVER_LIMIT: キーワードの作成上限数を超えています。<br> - AD_OVER_LIMIT: 広告の作成上限数を超えています。<br> - SYSTEM_ERROR_OCCURRED: システムエラーが発生しました。<br> 詳細は以下のヘルプを参照してください。<br> ・<a href=\"https://ads-help.yahoo-net.jp/s/article/H000053491?language=ja\">A/Bテストについて【検索広告】</a></div> <div lang=\"en\">Errors.<br> This field will be ignored on input.<br> Error details.<br> - ENTITY_USE_AD_CUSTOMIZER: You can't set up a campaign that contains ads using the ad customizer as the original campaign.<br> - ENTITY_UNDER_REVIEW: Can't create an A/B test. The campaign contains elements under review.<br> - CAMPAIGN_OVER_LIMIT: You already have the maximum number of campaigns.<br> - KEYWORD_OVER_LIMIT: You already have the maximum number of keywords.<br> - AD_OVER_LIMIT: You already have the maximum number of ads.<br> - SYSTEM_ERROR_OCCURRED: A system error has occurred.<br> See also the help below.<br> * <a href=\"https://ads-help.yahoo-net.jp/s/article/H000053491?language=en_US\">A/B test [Search Ads]</a></div> ")
