...
public class AbTest {
  ...
  **/
  ...
  public AbTest addErrorsItem(String errorsItem) {
   ...
   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt; エラー内容です。&lt;br&gt; このフィールドはリクエストの際には無視されます。&lt;br&gt; 以下エラー詳細になります。&lt;br&gt; - ENTITY_USE_AD_CUSTOMIZER: アドカスタマイザーを利用した広告が含まれるキャンペーンはテスト元のキャンペーンに設定できません。&lt;br&gt; - ENTITY_UNDER_REVIEW: 審査中のアイテムが含まれるためA/Bテストを作成できませんでした。&lt;br&gt; - CAMPAIGN_OVER_LIMIT: キャンペーンの作成上限数を超えています。&lt;br&gt; - KEYWORD_OVER_LIMIT: キーワードの作成上限数を超えています。&lt;br&gt; - AD_OVER_LIMIT: 広告の作成上限数を超えています。&lt;br&gt; - SYSTEM_ERROR_OCCURRED: システムエラーが発生しました。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Errors.&lt;br&gt; This field will be ignored on input.&lt;br&gt; Error details.&lt;br&gt; - ENTITY_USE_AD_CUSTOMIZER: You can&#39;t set up a campaign that contains ads using the ad customizer as the original campaign.&lt;br&gt; - ENTITY_UNDER_REVIEW: Can&#39;t create an A/B test. The campaign contains elements under review.&lt;br&gt; - CAMPAIGN_OVER_LIMIT: You already have the maximum number of campaigns.&lt;br&gt; - KEYWORD_OVER_LIMIT: You already have the maximum number of keywords.&lt;br&gt; - AD_OVER_LIMIT: You already have the maximum number of ads.&lt;br&gt; - SYSTEM_ERROR_OCCURRED: A system error has occurred.&lt;/div&gt; 
   * @return errors
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\"> エラー内容です。<br> このフィールドはリクエストの際には無視されます。<br> 以下エラー詳細になります。<br> - ENTITY_USE_AD_CUSTOMIZER: アドカスタマイザーを利用した広告が含まれるキャンペーンはテスト元のキャンペーンに設定できません。<br> - ENTITY_UNDER_REVIEW: 審査中のアイテムが含まれるためA/Bテストを作成できませんでした。<br> - CAMPAIGN_OVER_LIMIT: キャンペーンの作成上限数を超えています。<br> - KEYWORD_OVER_LIMIT: キーワードの作成上限数を超えています。<br> - AD_OVER_LIMIT: 広告の作成上限数を超えています。<br> - SYSTEM_ERROR_OCCURRED: システムエラーが発生しました。</div> <div lang=\"en\">Errors.<br> This field will be ignored on input.<br> Error details.<br> - ENTITY_USE_AD_CUSTOMIZER: You can't set up a campaign that contains ads using the ad customizer as the original campaign.<br> - ENTITY_UNDER_REVIEW: Can't create an A/B test. The campaign contains elements under review.<br> - CAMPAIGN_OVER_LIMIT: You already have the maximum number of campaigns.<br> - KEYWORD_OVER_LIMIT: You already have the maximum number of keywords.<br> - AD_OVER_LIMIT: You already have the maximum number of ads.<br> - SYSTEM_ERROR_OCCURRED: A system error has occurred.</div> ")
