...
import jp.co.yahoo.adssearchapi.v15.model.BaseAccountServiceValue;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">BaseAccountServicePageオブジェクトは、取得されるアカウント情報に関するエントリーを表します。</div> <div lang=\"en\">The BaseAccountServicePage object is a container for storing account information entry.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("BaseAccountServicePage")
...
public class BaseAccountServicePage {
  ...
  private List<BaseAccountServiceValue> values = null;
