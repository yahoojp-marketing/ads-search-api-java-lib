...
import jp.co.yahoo.adssearchapi.v16.model.AssetServiceAssetData;
import jp.co.yahoo.adssearchapi.v16.model.AssetServiceCustomParameters;
import jp.co.yahoo.adssearchapi.v16.model.AssetServiceTrademarkStatus;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">Assetオブジェクトは、アセット情報を格納します。<br> ※type=IMAGE, FAVICONのアセットを登録するときは最大1件となります。</div> <div lang=\"en\">Asset object contains the information of Asset.<br> *In the case of `type=IMAGE, FAVICON`, the operand size is limited to one item.</div> ")
@JsonPropertyOrder({
...
public class Asset {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\">アセットIDです。<br> このフィールドは、SET時に必須となり、ADD時に無視されます。</div> <div lang=\"en\">Asset ID.<br>This field is required in SET operation, and will be ignored in ADD operation.</div> ")
