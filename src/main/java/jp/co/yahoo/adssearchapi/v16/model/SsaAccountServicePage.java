...
import jp.co.yahoo.adssearchapi.v16.model.SsaAccountServiceValue;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">SsaAccountServicePageオブジェクトは、取得されるアカウントに関するエントリーを表します。</div> <div lang=\"en\">Account entry information.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("SsaAccountServicePage")
...
public class SsaAccountServicePage {
  ...
  private List<SsaAccountServiceValue> values = null;
