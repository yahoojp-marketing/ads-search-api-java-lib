 ...
 */
@ApiModel(description = "<div lang=\"ja\">SsaReportDefinitionServiceReportDateRangeオブジェクトは、レポートの集計対象期間を表します。<br> ADD時、このフィールドは省略可能となります。</div> <div lang=\"en\">SsaReportDefinitionServiceReportDateRange object displays date range of the report.<br> This field is optional in ADD operation.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("SsaReportDefinitionServiceReportDateRange")
