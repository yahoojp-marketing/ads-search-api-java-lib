...
import jp.co.yahoo.adssearchapi.v16.model.SsaReportDefinitionServiceReportSortType;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">SsaReportDefinitionServiceReportSortFieldオブジェクトは、レポート定義のソート詳細を表します。<br> ADD時、このフィールドは省略可能となります。</div> <div lang=\"en\">SsaReportDefinitionServiceReportSortField object describes sort details of report definition.<br> This field is optional in ADD operation.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("SsaReportDefinitionServiceReportSortField")
