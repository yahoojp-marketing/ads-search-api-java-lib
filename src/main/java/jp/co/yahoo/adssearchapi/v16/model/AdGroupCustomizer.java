...
import jp.co.yahoo.adssearchapi.v16.model.AdGroupCustomizerServiceApprovalStatus;
...
public class AdGroupCustomizer {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\">広告グループIDです。<br> ADDおよびREMOVE時、このフィールドは必須となります。</div> <div lang=\"en\">Ad group ID.<br> This field is required in ADD and REMOVE operation.</div> ")
