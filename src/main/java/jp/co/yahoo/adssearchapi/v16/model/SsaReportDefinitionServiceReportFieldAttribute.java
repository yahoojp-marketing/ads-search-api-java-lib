 ...
 */
@ApiModel(description = "<div lang=\"ja\">SsaReportDefinitionServiceReportFieldAttributeオブジェクトは、レポート定義の作成に使用できるフィールドを表します。</div> <div lang=\"en\">SsaReportDefinitionServiceReportFieldAttribute object describes the available field to create report definition.</div> ")
@JsonPropertyOrder({
...
@JsonTypeName("SsaReportDefinitionServiceReportFieldAttribute")
