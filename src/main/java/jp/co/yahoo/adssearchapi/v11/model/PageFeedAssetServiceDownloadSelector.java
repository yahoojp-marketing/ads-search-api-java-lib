 ...
 */
@ApiModel(description = "<div lang=\"ja\">ページフィードアセットのダウンロード処理を実施します。</div> <div lang=\"en\">Download page feed assets.</div> ")
@JsonPropertyOrder({
  PageFeedAssetServiceDownloadSelector.JSON_PROPERTY_ACCOUNT_ID,
  PageFeedAssetServiceDownloadSelector.JSON_PROPERTY_JOB_ID
})
@JsonTypeName("PageFeedAssetServiceDownloadSelector")
