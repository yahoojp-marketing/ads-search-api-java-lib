...
import jp.co.yahoo.adssearchapi.v11.model.FeedItemServiceDayOfWeek;
import jp.co.yahoo.adssearchapi.v11.model.FeedItemServiceMinuteOfHour;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * &lt;div lang&#x3D;\&quot;ja\&quot;&gt;FeedItemServiceScheduleオブジェクトは、広告表示アセットの配信スケジュール設定を表します。&lt;br&gt; このフィールドは、ADDおよびSET時に省略可能となります。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;FeedItemServiceSchedule object describes display schedule from ad display asset.&lt;br&gt; This field is optional in ADD and SET operation.&lt;/div&gt; 
 */
@ApiModel(description = "<div lang=\"ja\">FeedItemServiceScheduleオブジェクトは、広告表示アセットの配信スケジュール設定を表します。<br> このフィールドは、ADDおよびSET時に省略可能となります。</div> <div lang=\"en\">FeedItemServiceSchedule object describes display schedule from ad display asset.<br> This field is optional in ADD and SET operation.</div> ")
@JsonPropertyOrder({
