...
import jp.co.yahoo.adssearchapi.v11.model.AuditLogServiceEventTypes;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AuditLogServiceEventSelectorオブジェクトは、操作履歴の取得対象を設定します。&lt;br&gt; このフィールドは、必須です。&lt;br&gt; 1~25件の指定が可能です。&lt;br&gt; ※このフィールドは、レスポンスの際に返却されません。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AuditLogServiceEventSelector object enables the target setting of acquiring operation history.&lt;br&gt; This field is required.&lt;br&gt; 1 to 25 items can be specified.&lt;br&gt; * This field is not returned in the response.&lt;/div&gt; 
 */
@ApiModel(description = "<div lang=\"ja\">AuditLogServiceEventSelectorオブジェクトは、操作履歴の取得対象を設定します。<br> このフィールドは、必須です。<br> 1~25件の指定が可能です。<br> ※このフィールドは、レスポンスの際に返却されません。</div> <div lang=\"en\">AuditLogServiceEventSelector object enables the target setting of acquiring operation history.<br> This field is required.<br> 1 to 25 items can be specified.<br> * This field is not returned in the response.</div> ")
@JsonPropertyOrder({
