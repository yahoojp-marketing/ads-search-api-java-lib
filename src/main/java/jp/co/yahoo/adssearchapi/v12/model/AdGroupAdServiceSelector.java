...
import jp.co.yahoo.adssearchapi.v12.model.AdGroupAdServiceCreatedDateRange;
...
public class AdGroupAdServiceSelector {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "<div lang=\"ja\">検索条件：広告グループID</div> <div lang=\"en\">Search condition: Ad group ID.<br> Ads returned will be from ad groups whose ids are included in this list.</div> ")
