...
import jp.co.yahoo.adssearchapi.v12.model.AccountTrackingUrlServiceValue;
 ...
 */
@ApiModel(description = "<div lang=\"ja\">AccountTrackingUrlServiceReturnValueオブジェクトは、アカウントトラッキング情報を含む結果として戻される値を表します。</div> <div lang=\"en\">AccountTrackingUrlServiceReturnValue object describes account tracking details.</div> ")
@JsonPropertyOrder({
