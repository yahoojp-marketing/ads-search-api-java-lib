 ...
 */
public enum AccountCustomizerServiceApprovalStatus {
  ...
  AccountCustomizerServiceApprovalStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static AccountCustomizerServiceApprovalStatus fromValue(String value) {
    for (AccountCustomizerServiceApprovalStatus b : AccountCustomizerServiceApprovalStatus.values()) {
