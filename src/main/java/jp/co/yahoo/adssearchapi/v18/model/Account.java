...
import jp.co.yahoo.adssearchapi.v18.model.AccountServiceAutoTaggingEnabled;
import jp.co.yahoo.adssearchapi.v18.model.AccountServiceDeliveryStatus;
import jp.co.yahoo.adssearchapi.v18.model.AccountServiceIsCancellationPending;
import jp.co.yahoo.adssearchapi.v18.model.AccountServiceIsMccAccount;
import jp.co.yahoo.adssearchapi.v18.model.AccountServiceIsTestAccount;
import jp.co.yahoo.adssearchapi.v18.model.AccountServiceStatus;
import jp.co.yahoo.adssearchapi.v18.model.AccountServiceType;
...
public class Account {
  ...
  **/
  ...
  public Account contactBizId(String contactBizId) {
   ...
   /**
   * &lt;div lang&#x3D;\&quot;ja\&quot;&gt;アカウント管理者のビジネスIDです。&lt;br&gt; MCCアカウントの場合、このフィールドは返却されず、リクエストの際も無視されます。&lt;br&gt; テストアカウントの場合、このフィールドは更新できません。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Contact Business ID.&lt;br&gt; If isManagerAccount is \&quot;TRUE\&quot;, this field will not be returned and will be ignored on request.&lt;br&gt; If isTestAccount is \&quot;TRUE\&quot;, this field cannot be set.&lt;/div&gt; 
   * @return contactBizId
  **/
  @jakarta.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, accountName, accountStatus, accountType, autoTaggingEnabled, deliveryStatus, isTestAccount, isCancellationPending, startDate, endDate, isMccAccount, contactBizId);
  }
