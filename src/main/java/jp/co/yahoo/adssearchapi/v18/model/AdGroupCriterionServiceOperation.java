 ...
 */
@JsonPropertyOrder({
  AdGroupCriterionServiceOperation.JSON_PROPERTY_ACCOUNT_ID,
  AdGroupCriterionServiceOperation.JSON_PROPERTY_OPERAND
})
...
public class AdGroupCriterionServiceOperation {
  ...
  private List<AdGroupCriterion> operand;

  public AdGroupCriterionServiceOperation() {
  }
