...
@JsonPropertyOrder({
  CampaignServiceManualCpcBiddingScheme.JSON_PROPERTY_ENHANCED_CPC_ENABLED
})
@JsonTypeName("CampaignServiceManualCpcBiddingScheme")
...
public class CampaignServiceManualCpcBiddingScheme {
  ...
  public CampaignServiceManualCpcBiddingScheme() { 
  }
