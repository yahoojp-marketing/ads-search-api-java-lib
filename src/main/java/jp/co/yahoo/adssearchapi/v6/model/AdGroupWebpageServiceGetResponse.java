...
import jp.co.yahoo.adssearchapi.v6.model.AdGroupWebpageServicePage;
...
public class AdGroupWebpageServiceGetResponse   {
  ...
  @JsonProperty("rval")
  private AdGroupWebpageServicePage rval = null;
  ...
  */
  ...
  public AdGroupWebpageServicePage getRval() {
    return rval;
  }

  public void setRval(AdGroupWebpageServicePage rval) {
    this.rval = rval;
  }
