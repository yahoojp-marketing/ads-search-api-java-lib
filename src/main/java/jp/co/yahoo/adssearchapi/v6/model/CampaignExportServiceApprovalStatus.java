 ...
 */
public enum CampaignExportServiceApprovalStatus {
  ...
  CampaignExportServiceApprovalStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static CampaignExportServiceApprovalStatus fromValue(String value) {
    for (CampaignExportServiceApprovalStatus b : CampaignExportServiceApprovalStatus.values()) {
